...
#include <cstring>
using namespace std;
class CWH{     //This is abstract base class we just create such classes to derive other classes from it.
//Class which has pure virtual function in it is called abstract base class
    protected:
    string title;
    float rating;
    public:
    ...
    virtual void display() = 0; //do nothing function--->means pure virtual function
    //Means u have to create display fun in each class
};
